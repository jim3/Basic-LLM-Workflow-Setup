...
Initial experiments with function calling and the [Gemini API](https://ai.google.dev/gemini-api/docs). The script covers the classic 4-step function calling loop that powers modern LLM workflows.
